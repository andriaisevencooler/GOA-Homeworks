...
export default function RouterSystem() {
    return (
        <div className='flex w-full h-[10%] bg-[#aaa] items-center justify-between'>
            <Link to={'/'} className='p-[15px] hover:underline font-mono tracking-wide text-[1.2rem]'>Sea Turtle</Link>
            <Link to={'/touristsaagento'} className='p-[15px] hover:underline font-mono tracking-wide text-[1.2rem]'>Tourist Saagento</Link>
